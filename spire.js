const GAME_CONFIG = {
  ...
  cardPool: [
    ...
    { id: 'atk2', type: 'attack', value: 5, cost: 1, icon: '🗡️', label: 'Big Bonk', artSrc: 'assets/big_bonk.png' },
    ...
    { id: 'atk8', type: 'attack', value: 7, cost: 1, icon: '🗡️', label: 'Frozen Solid', artSrc: 'assets/ice_dog.png' },
    { id: 'blk1', type: 'block', value: 2, cost: 1, icon: '🛡️', label: 'Hide', artSrc: 'assets/hide.png' },
    { id: 'blk2', type: 'block', value: 4, cost: 1, icon: '🛡️', label: 'Defend', artSrc: 'assets/dad_defend.png' },
    { id: 'blk3', type: 'block', value: 5, cost: 1, icon: '🛡️', label: 'Super Defend', artSrc: 'assets/jolene_defend.png' },
